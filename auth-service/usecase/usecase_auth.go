...
func (u *AuthUseCase) LoginUser(ctx context.Context, email, password string) (*models.Auth, error) {
...
func (u *AuthUseCase) UpdateMe(ctx context.Context, user *models.Auth) (*authDto.RegisterRequest, error) {
